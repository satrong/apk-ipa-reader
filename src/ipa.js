import { PNGReader, getPlist, getUdids, PNGConvertor } from './lib.js';
...
export default function (a, c) {
    var f, i, m, n, o, p, q, r, s, t, u, h = 0, k = 0;
    var p = false;
    ...
    t["60x60@3x"] ?
        getIcon(t["60x60@3x"]) : t["60x60@2x"]
            ? getIcon(t["60x60@2x"]) : t["57x57@3x"]
                ? getIcon(t["57x57@3x"]) : t["57x57@2x"]
                    ? getIcon(t["57x57@2x"]) : t["icon@3x.png"]
                        ? getIcon(t["icon@3x.png"]) : t["icon@2x.png"]
                            ? getIcon(t["icon@2x.png"]) : t["76x76@2x~ipad.png"]
                                ? getIcon(t["76x76@2x~ipad.png"]) : t["40x40@2x~ipad.png"]
                                    ? getIcon(t["40x40@2x~ipad.png"]) : t["29x29@2x~ipad.png"]
                                        ? getIcon(t["29x29@2x~ipad.png"]) : t["icon.png"] && getIcon(t["icon.png"]);

    if (f !== 0) {
        s = function (a) {
            a.ProvisionsAllDevices ? (g.release_type = "inhouse",
                g.distributionName = a.Name + ": " + a.TeamName) : a.ProvisionedDevices ? (g.release_type = "adhoc",
                    g.devices = a.ProvisionedDevices) : g.release_type = "store",
                g.expire_at = a.ExpirationDate,
                h = 1;
            // c("embedded ready")
        };
    ...
    if (u !== 0) {
        r = function (b) {
            ...
            if (0 === o) {
                ...
                if (q)
                    for (q instanceof Array || (q = b.CFBundleIcons && b.CFBundleIcons.CFBundlePrimaryIcon ? b.CFBundleIcons.CFBundlePrimaryIcon.CFBundleIconFiles : b.CFBundleIconFiles && b.CFBundleIconFiles instanceof Array ? b.CFBundleIconFiles : []),
                        n = 0; n < q.length;) {
                        if (t = q[n].toLowerCase(),
                            t.indexOf("@3x.png") > 0 || t.indexOf("icon-60") >= 0 || t.indexOf("@2x.png") > 0 || t.indexOf("114") >= 0 || t.indexOf("120.") >= 0 || t.indexOf("144") >= 0 || t.indexOf("40x40") >= 0) {
                            for (r = 0; r < a.length;) {
                                if (i = a[r],
                                    m = i.filename.toLowerCase().split(".app/"),
                                    m = m.length > 1 ? m[1] : m[0],
                                    t.indexOf(".png") < 1 && (l = t + ".png"),
                                    m === t || m === l) {
                                    o = i;
                                    break
                                }
